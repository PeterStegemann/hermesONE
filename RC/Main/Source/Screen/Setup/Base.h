...
#define SCREEN_SETUP_BASE_MENU_MARKER_WIDTH		(( uint16_t) 4)
#define SCREEN_SETUP_BASE_MENU_MARKER_HEIGHT	(( uint16_t) 6)
#define SCREEN_SETUP_BASE_MAIN_FONT				avr::font::FI_Normal
#define SCREEN_SETUP_BASE_TITLE_FONT			avr::font::FI_Large
