...
#include "AVR/Source/LCD/S6E63D6/S6E63D6_Parallel.h"
//#include "AVR/Components/LCD/S6E63D6/S6E63D6_SPI.h"
...
//	LCD_S6E63D6_SPI Lcd;
    ...
    void doFly( void)
    {
        ...
        while( true)
        {
            ...
            lcd.DrawLine( X, Y, X2, Y2, ( LCD_65K_RGB::Color) CurrentColor);
    ...
    void doFractal( void)
    {
    	...
    	while( X < resolutionWidth)
    	{
    		...
    		while( Y < resolutionHeight)
    		{
    			...
    			lcd.DrawPixel
    			(
    			    X, Y, LCD_65K_RGB_COLOR( CurrentIteration & 7, CurrentIteration & 192, CurrentIteration & 63)
                );
    ...
    //	    			    LCD::PO_Proportional, "%d", ColorPart);
        	...
        	lcd.Print
        	(
                120, 100, avr::font::FI_Large, CurrentColor, LCD_65K_RGB::C_Black, LCD::PO_Proportional, "hermesONE"
            );
