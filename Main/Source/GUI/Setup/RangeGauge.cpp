...
#include "RangeGauge.h"

GUI_Setup_RangeGauge::GUI_Setup_RangeGauge( void)
					: lowerLimit( 0)
					, upperLimit( 0)
{
...
void GUI_Setup_RangeGauge::SetRange( int16_t LowerLimit, int16_t UpperLimit)
{
	if( remembered == true)
	{
...
void GUI_Setup_RangeGauge::Display( int16_t Minimum, int16_t Maximum, int16_t Value)
{
	if( remembered == true)
	{
