...
void GUI_Setup_Graph::updateGraph( int16_t NewGraphPoint[], uint8_t NewGraphPoints)
{
...
void GUI_Setup_Graph::display( int16_t Marker, int16_t NewGraphPoint[], uint8_t NewGraphPoints,
							   bool GraphUpdated)
{
...
void GUI_Setup_Graph::displayFrame( void)
{
	if( size == 0)
	{
		return;
...
void GUI_Setup_Graph::drawLine( uint16_t Left, uint16_t Top, int16_t LowerX, int16_t LowerY,
							    int16_t UpperX, int16_t UpperY, uint16_t Size,
...
void GUI_Setup_Graph::SetMode( ClipOrWarpMode Mode)
{
	if( mode == Mode)
	{
		return;
